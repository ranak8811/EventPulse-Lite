...
export type StorageHash =
  StorageHashBase<'0c0ec06e4b08c3e2f32b56d7095d7ffe4fa0a5ba13fab8250f4a30f76266d4f8'>;
export type ExecutionHash =
  ExecutionHashBase<'773b516ef9752487050e34e4882d183b2181de012a9a183ad86bfc6c845baa08'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Event: {
      ...
      readonly category: 'TECH' | 'BUSINESS' | 'WORKSHOP' | 'MUSIC';
      readonly totalSeats: CodecTypes['pg/int4@1']['output'];
      readonly bookedSeats: CodecTypes['pg/int4@1']['output'];
      readonly status: 'UPCOMING' | 'COMPLETED' | 'CANCELLED';
...
export type FieldInputTypes = {
  readonly public: {
    readonly Event: {
      ...
      readonly bookedSeats: CodecTypes['pg/int4@1']['input'];
      readonly status: 'UPCOMING' | 'COMPLETED' | 'CANCELLED';
...
export namespace Models {
  export type public_Event = {
    ...
    category: 'TECH' | 'BUSINESS' | 'WORKSHOP' | 'MUSIC';
    totalSeats: CodecTypes['pg/int4@1']['output'];
    bookedSeats: CodecTypes['pg/int4@1']['output'];
        ...
        readonly entries: {
          ...
          readonly valueSet: {
            readonly EventCategory: {
              ...
              readonly values: readonly ['TECH', 'BUSINESS', 'WORKSHOP', 'MUSIC'];
            };
            readonly EventStatus: {
              readonly kind: 'valueSet';
              readonly values: readonly ['UPCOMING', 'COMPLETED', 'CANCELLED'];
            };
          };
        };
      };
          ...
          readonly Event: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly bookedSeats: { readonly column: 'bookedSeats' };
        ...
        readonly enum: {
          readonly EventCategory: {
            ...
            readonly members: readonly [
              ...
              { readonly name: 'MUSIC'; readonly value: 'MUSIC' },
            ];
          };
          readonly EventStatus: {
            readonly codecId: 'pg/text@1';
